...
public class MibLoaderBits {
    ...
    static void addPtc12Members(SpaceSystem spaceSystem, AggregateDataType.Builder<?> aggrb, int pfc) {
        ...
        aggrb.addMember(new Member("ccsds_ph_version", getIntegerDataType(spaceSystem, 3, argument)));
        aggrb.addMember(new Member("ccsds_ph_packettype", getIntegerDataType(spaceSystem, 1, argument)));
        aggrb.addMember(new Member("ccsds_ph_shflag", getIntegerDataType(spaceSystem, 1, argument)));
        aggrb.addMember(new Member("ccsds_ph_apid", getIntegerDataType(spaceSystem, 11, argument)));
        aggrb.addMember(new Member("ccsds_ph_seqflag", getIntegerDataType(spaceSystem, 2, argument)));
        aggrb.addMember(new Member("ccsds_ph_seqcount", getIntegerDataType(spaceSystem, 14, argument)));
        aggrb.addMember(new Member("ccsds_ph_length", getIntegerDataType(spaceSystem, 16, argument)));
        if (pfc == 0) { // TM packet
            ...
            aggrb.addMember(new Member("pus_stype", getIntegerDataType(spaceSystem, 8, argument)));
            aggrb.addMember(new Member("pus_subtype", getIntegerDataType(spaceSystem, 8, argument)));
